...
const ICON_TRACK_1 = new Icon(require("../../assets/avici.jpg"), 166, 5);
const ICON_THUMB_1 = new Icon(require("../../assets/avici.jpg"), 18, 19);
const ICON_THUMB_2 = new Icon(require("../../assets/avici.jpg"), 15, 19);
